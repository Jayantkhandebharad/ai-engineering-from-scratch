...
function writeBuildMeta() {
  ...
  // Derive the repo (owner/slug) this deploy was built from, so a fork serves
  // its own lesson docs/outputs instead of always pulling from upstream.
  let repo = '';
  ...
  if (!repo) repo = 'rohitg00/ai-engineering-from-scratch';
